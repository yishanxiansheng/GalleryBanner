...
//        }
        ...
        //指示器部分
        indicatorRecyclerView = new RecyclerView(context);
        ...
        addView(indicatorRecyclerView, params);
        if (!showIndicator) {
            indicatorRecyclerView.setVisibility(GONE);
        }
    }
    ...
    public void setShowIndicator(boolean showIndicator) {
        ...
        indicatorRecyclerView.setVisibility(showIndicator ? VISIBLE : GONE);
    }
